    ...
    return Scaffold(
      body: Container(
            ...
            Column(
              children: [
                circularGradientConatiner(
                  ...
                  const Text(StringConstants.graceAge).bold(
                          ColorConstant.black,
                          TextAlign.center,
        ...
        SizedBox(
            ...
            // children: [
            //   Positioned(
            //     bottom: DimensionConstants.d17.h,
                //child: 
                Row(
                         ...
                         SizedBox(
                          ...
                          width: DimensionConstants.d122.w,
                           child: const Row(
                            ...
                            children: [
                               ImageView(path: ImageConstants.addImageIcon,),
                                ImageView(path: ImageConstants.galleryIconMessageScreen,),
                                 ImageView(path: ImageConstants.cameraIconMessageScreen,),
                                  ImageView(path: ImageConstants.mikeIconMessageScreen,)
                         
                            ],
                           ),
                         ),
                         const Text(StringConstants.yourMessage).regularText(ColorConstant.black.withOpacity(0.5), TextAlign.center, DimensionConstants.d14.sp),
                        ],
                      ),
                    ),
                                ),
                   
                    const ImageView(path: ImageConstants.sendMessageIconMessageScreen,)
                  ],
                ),
