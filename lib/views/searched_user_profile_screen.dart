...
class SearchedUserProfileScreen extends StatefulWidget {
  final  userName;
   final  userImagePath;
  const SearchedUserProfileScreen({Key? key, required this.userName, required this.userImagePath})
      : super(key: key);
...
class _SearchedUserProfileScreenState extends State<SearchedUserProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   elevation: DimensionConstants.d0,
      //   title:  Row(
      //       children: [
      //         const ImageView(
      ...
      //           children: [
      //             const Text(StringConstants.pooja).regularText(
      //                 ColorConstant.black,
      //                 TextAlign.center,
      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          Row(
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(widget.userName ).regularText(
                      ColorConstant.black,
                      TextAlign.center,
                      DimensionConstants.d20.sp),
                  const Text(StringConstants.online).regularText(
          ...
          chatContainer(
              containerBgColor:
                  ColorConstant.dashboardGradientColor1.withOpacity(0.2),
          ...
          Align(
            ...
            child: const Text(StringConstants.messageSendTime).regularText(
                ColorConstant.black.withOpacity(0.4),
                TextAlign.center,
                DimensionConstants.d12.sp),
          ),
          ...
          chatContainer(
              containerBgColor: ColorConstant.searchUserScreenContainerColor,
          ...
          ListView(
            ...
            shrinkWrap: true,
            children: [
              SingleChildScrollView(child: chatTextField()),
            ],
          )
        ]),
      ),
