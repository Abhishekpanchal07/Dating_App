...
class SendMessageScreen extends StatefulWidget {
  ...
  const SendMessageScreen({super.key, required this.opponentId});
  ...
  Widget build(BuildContext context) {
    return BaseView<GettingUserDetailsProvider>(
      onModelReady: (provider) {
        provider.matchedSingleUserDetail(context,
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const ImageView(
                  path: ImageConstants.sendMessageScreenPic,
                ),
                SizedBox(
                  height: DimensionConstants.d21.h,
                ),
                const Text(StringConstants.sendMessageScreenText).bold(
                    ColorConstant.red,
                    TextAlign.center,
                    DimensionConstants.d30.sp),
                const Text(StringConstants.sendMessageScreenText1).regularText(
                    ColorConstant.black,
                    TextAlign.center,
                ...
                GestureDetector(
                  onTap: () => Navigator.pushNamed(
                      ...
                      arguments:  OneToOneChatScreen(
                          userName: provider.matchedUserFullName,
                          userImagePath: ApiUrls.baseUrl + provider.matchedUserprofilepicurl)),
                  child: Container(
                      height: DimensionConstants.d56.h,
                      width: DimensionConstants.d256.w,
                      decoration: BoxDecoration(
                        borderRadius:
                            BorderRadius.circular(DimensionConstants.d10),
                      ...
                      child: Center(
                        child: const Text(StringConstants.sendMessage)
                            .regularText(ColorConstant.textcolor,
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: ColorConstant.dashboardGradientColor1
                              .withOpacity(0.1)),
                      child: Center(
                        child: const Text(StringConstants.keepSwiping)
                            .regularText(ColorConstant.red, TextAlign.center,
